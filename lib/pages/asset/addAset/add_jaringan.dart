...
class AddJaringan extends StatefulWidget {
  const AddJaringan({Key? key}) : super(key: key);

  @override
  State<AddJaringan> createState() => _AddJaringanState();
}

class _AddJaringanState extends State<AddJaringan> {
  final _addJaringanKey = GlobalKey<FormState>();
  ...
  final frekC = TextEditingController();
  final kecDataC = TextEditingController();
  final garansiC = TextEditingController();
  final umurAsetC = TextEditingController();
